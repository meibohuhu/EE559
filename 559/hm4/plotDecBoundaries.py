...
def plotDecBoundaries(training, label_train,w_proj):
    ...
    # else:
    #     l1 = plt.legend([m1,m2], ['Class 3 Mean', 'non-Class 3 Mean'], loc=4)
    ...
    plt.plot(x_plot, -1 * w_proj[0] * x_plot / w_proj[1], c='r')
    plt.show()
    return
